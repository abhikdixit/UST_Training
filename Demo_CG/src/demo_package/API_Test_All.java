...
@Test
  ...
  String ExpectedAddress = "Chicago, IL, USAA";
 //validating Address as per the requirement
 if(formatAddress.equalsIgnoreCase(ExpectedAddress))
  {
	 System.out.println("Address is as Expected");
	 Assert.assertEquals(formatAddress, ExpectedAddress); 
  ...
  //Assert.assertEquals(ExpectedAddress, formatAddress);
  //Assert.assertTrue("Address is not as Expected", True);
  }
